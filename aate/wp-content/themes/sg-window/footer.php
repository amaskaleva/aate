...
?>	
		...
		<?php if (!is_front_page() && !is_home() && ! is_page_template( 'page-templates/no-content-footer.php' ) )
		...
		<footer id="colophon" class="site-footer  <?php if(is_home())echo "home"; ?>">

			<?php do_action('sgwindow_site_info'); ?>
			<?php do_action('sgwindow_footer_site_info'); ?>
