 ...
 * @since Tatva 1.0
 */
include_once "customwidgets.php";
...
function tatva_widgets_init() {
	...
	register_sidebar( array(
		'name' => esc_html__( 'Footer Additional Widget', 'tatva' ),
		'id' => 'footer-additional',
		'description' => esc_html__( 'Additional To Footer', 'tatva' ),
		'before_widget' => '<div>',
		'after_widget' => '<div>',
		'before_title' => '',
		'after_title' => ''
...
function tatva_customstyles() {
	?>
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/customstyle.css" type="text/css" meta="all">
	 <!--[if lte IE 9]>
	 <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/customstyle_ie.css" type="text/css" meta="all">
	<![endif]-->
	<?php
}
add_action( 'wp_head', 'tatva_customstyles', 20 );